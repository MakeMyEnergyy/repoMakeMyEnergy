...
export default function UploadImage({ route }) {
  ...
  const uploadImage = async (e) => {
    ...
    if (!validFileTypes.find(type => type === file.type)) {
      setError("File must be in .jpg, .png, .jpeg")
      return;
    }
    ...
    await axios.post(`/route/uploadImage/${route}/${localStorage.getItem("makemyenergy_Email")}`, form, { withCredentials: true }).then((response) => {
            ...
            >
              ...
              >
                ...
                <Stack p="2" textAlign="center" spacing="1">
                  ...
                  <Text fontWeight="light">Supported: .jpg, .png, .jpeg</Text>
                </Stack>
              </Stack>
