...
export default function AddCharger() {
    ...
    async function onSubmit(data) {
      ...
      let price = [data.first_price];
        ...
        try {
          const response = await axios.post(`http://localhost:3050/route/addProduct/charger`, form);
    ...
    return (
      <>
        <Button colorScheme="orange" onClick={onOpen}>
          <BsPlusLg className="font-bold mr-3" /> Add Charger
        </Button>
              ...
              <ModalBody pb={6}>
                ...
                >
                  ...
                  <div className="border-2 border-gray-400 p-2 m-2 rounded-xl">
                    <Box>
                      <FormControl>
                        <FormLabel>Charger 1 - Size</FormLabel>
                        <Input
                          ref={initialRef}
                          placeholder="Charger Size"
                          {...register(`first_size`, {
                            required: true,
                          })}
                        />
                    ...
                    <Box>
                      <FormControl>
                        <FormLabel>Charger 1 - Price</FormLabel>
                        <Input
                          ref={initialRef}
                          placeholder="Charger Price"
                  ...
                  {array1Fields.map((item, index) => (
                    ...
                    >
                      <Box>
                        <FormControl>
                          <FormLabel>Charger {index + 2} - Size</FormLabel>
                          <Input
                            ref={initialRef}
                            placeholder="Charger Size"
                      ...
                      <Box>
                        <FormControl>
                          <FormLabel>Charger {index + 2}- Price</FormLabel>
                          <Input
                            ref={initialRef}
                            placeholder="Charger Price"
