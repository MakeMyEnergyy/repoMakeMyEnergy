...
export default function AddBattery() {
    ...
    async function onSubmit(data) {
        ...
        try {
          const response = await axios.post(`/route/addProduct/battery`, data,{
            ...
            <ModalContent>
              ...
              <ModalBody pb={6}>
                ...
                >
                  ...
                  <Box>
                    <FormControl>
                      <FormLabel>Without eps Price</FormLabel>
                      <Input
                        
                        placeholder="Without eps"
                  ...
                  <Box>
                    <FormControl>
                      <FormLabel>With eps Price</FormLabel>
                      <Input
                        
                        placeholder="With eps"
