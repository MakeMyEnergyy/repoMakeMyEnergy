  ...
  return (
    <div>
        ...
        {dropDown == true ?
          <span className='z-20'>
            ...
            <div className='absolute top-[11vh] items-center space-y-2 py-4 left-0 bg-gradient-to-r from-[#FBC2EB]/100 to-[#A6C1EE]/100 w-full flex flex-col'>
              <Menu>
                <MenuButton className='px-[1vw] py-[1vw]'>  <Link href="/about"><p>About</p></Link> </MenuButton>
              ...
              <Menu>
                ...
                <MenuList className='ml-[5vw] w-[88vw] mr-[5vw] flex flex-col items-center justify-center'>
                  ...
                  <MenuDivider />
                  <Link href="/complaint-handling"><MenuItem>Complaint Handling Procedures</MenuItem></Link>
                  {/* <MenuDivider />
                  <Link href="/comingSoon"><MenuItem>Covid - 19 Precautions</MenuItem></Link>
                  <MenuDivider /> */}
                  <Link href="/consumer-code"><MenuItem>New Energy Tech Consumer Code</MenuItem></Link>
                  <MenuDivider />
      ...
      <div className='hidden md:flex pl-[10vw] pr-[6vw] lg:mr-[4vw]'>
        <Menu>
        <span className='flex flex-row mt-4'>  <Link href="/about"><MenuItem>About</MenuItem></Link> </span>
        ...
        <Menu>
          ...
          <MenuList>
            ...
            <Link href="/comingSoon"><MenuItem>Solar Installation - Metro</MenuItem></Link>
            <MenuDivider /> */}
            <Link href="/residential_solar"><MenuItem>Residential Solar</MenuItem></Link>
            <MenuDivider />
            <Link href="/commercial_solar"><MenuItem>Commercial Solar</MenuItem></Link>
            <MenuDivider />
            <Link href="/upgrade_hot_water_system"><MenuItem>Heat Pump Installation</MenuItem></Link>
            <MenuDivider />
            <Link href="/upgrade_air_con_system"><MenuItem>Air Con Installation</MenuItem></Link>
          </MenuList>
        </Menu>
        <Menu>
        ...
        <Menu>
          ...
          <MenuList>
            ...
            <Link href="/consumer-code"><MenuItem>New Energy Tech Consumer Code</MenuItem></Link>
            <MenuDivider />
            <Link href="/term_condition"><MenuItem>Terms and Conditions</MenuItem></Link>
          </MenuList>
        </Menu>
        <Menu>
          <div>
