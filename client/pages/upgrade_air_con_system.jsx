  ...
  return (
    <div>
      <Head>
        ...
        })(window,document,'script','dataLayer','GTM-TGF6GBH6');</script>
        <!-- End Google Tag Manager -->
      </Head>
      <main>
        <!-- Google Tag Manager (noscript) -->
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TGF6GBH6"
        ...
        <div>
          ...
          <div className="flex flex-col p-5 items-center bg-gradient-to-r from-[#FFD1FF]/40 to-[#FAD0C4]/30 rounded-md pb-16">
