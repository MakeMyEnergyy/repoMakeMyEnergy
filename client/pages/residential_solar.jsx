...
export default function Residential_Solar() {
  ...
  return (
    <div>
      ...
      <main>
        <div>
          <div className="bg-gradient-to-r p-5 from-[#A6C1EE]/20 to-[#FBC2EB]/30">
            <Navbar />
          ...
          <section className="bg-white  mx-20 ">
            {/* <div className="flex flex-col items-center mb-8">
              ...
              */}
            <p className="text-gray-700 text-lg mb-8 mt-5">
              Are you tired of watching your electricity bills climb ever higher? Reduce your carbon footprint and make a positive impact on the environment with our solar solutions. It's time to discover the incredible potential of solar energy for your home, and Make My Energy is here to guide you on this journey.
            </p>
            <p className="text-gray-700 text-lg mb-8">
              We're committed to providing you with top-notch residential solar solutions that not only save you money but also help reduce your carbon footprint. Say goodbye to soaring electricity bills and hello to clean, sustainable energy for your home.
            </p>
            {/* <button className="bg-blue-900 text-white text-lg font-semibold py-2 px-4 rounded-full">
              Learn More
            </button> */}
          </section>
          <div className="flex flex-col items-center  from-[#FFD1FF]/40 to-[#FAD0C4]/30 rounded-md pb-16">
          ...
          <div className="flex flex-col items-center rounded-md pb-16">
            <p className="text-3xl pt-[5vh] pb-[2.5vh] text-center font-extrabold mb-5">
          ...
          <div className="flex flex-col items-center rounded-md pb-16">
            ...
            <ul className="list-disc list-inside text-lg mx-20">
              <li className="mb-2">
                <span className="font-semibold">Quality Assurance:</span> We use Tier 1 solar panels and high-quality inverters to ensure optimal performance and durability.
              </li>
              <li className="mb-2">
                <span className="font-semibold">Quality Assurance:</span> Our installations are carried out by Clean Energy Council-accredited professionals, guaranteeing safety and efficiency.
              </li>
              <li className="mb-2">
                <span className="font-semibold">Expert Guidance: </span>Our friendly and knowledgeable team provides expert advice tailored to your specific energy needs, ensuring you get the best system for your home.
              </li>
              <li className="mb-2">
                <span className="font-semibold">Ongoing Support: </span> We're committed to your long-term satisfaction. Beyond installation, we offer maintenance and support services to keep your solar system running smoothly.
              </li>
            </ul>
          </div>
