...
export default function Upgrade_Hot_Water_System() {
        ...
        <div>
          <div className="bg-gradient-to-r from-[#A6C1EE]/20 to-[#FBC2EB]/30">
            ...
            <div className="w-full items-center flex flex-col mt-[5vh]">
              <p className="text-4xl font-extrabold ">
                Upgrade Your Hot Water System to Energy Efficient System
              </p>
              <p className="py-[1vh]">
                Services /{" "}
          ...
          <section className="bg-white p-10">
            ...
            <p className="text-gray-700 text-lg mb-8">
              Switching to a more energy efficient hot water system will help
              you reduce the amount of energy and water you use. This means you
              can expect to see long-term cost savings on your bills.
            </p>
            <Link
              href="#form"
              scroll={false}
          ...
          <div className="flex flex-col p-5  bg-gradient-to-r from-[#FFD1FF]/40 to-[#FAD0C4]/30 rounded-md pb-16">
            <p className="text-3xl pt-[5vh] pb-[2.5vh] text-center font-extrabold mb-5">
              Choosing energy efficient Hot Water system has many benefits
            </p>
            <ul className="list-disc list-inside text-lg">
              <li className="mb-2">Long-term savings on your power bills</li>
              <li className="mb-2">Reduce amount of energy and water used.</li>
              <li className="mb-2">Lower your environmental impact.</li>
              <li className="mb-2">Access to government rebates.</li>
            </ul>
          </div>
          <div className="flex flex-col p-5 items-center rounded-md pb-16">
            ...
            <ul className="list-disc list-inside text-lg">
              ...
              <li className="mb-2">
                Choose the hot water system that best suits your needs.
              </li>
              <li className="mb-2">
                Our expert technician will install the Air con.
              </li>
              <li className="mb-2">
                Technician will dispose of and recycle your old hot water
                system, as well as any other equipment that is being replaced.
              </li>
              <li className="mb-2">
                Enjoy your new hot water system! If you have any issues, contact
